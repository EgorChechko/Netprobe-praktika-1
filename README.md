## README.md (пример для вашего репозитория)

Ниже приведён файл `README.md`, который вы можете добавить в корень проекта. Он содержит инструкцию по сборке, настройке уведомлений и тестированию на хосте.
